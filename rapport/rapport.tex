...
\begin{itemize}
	\item Suppression de l'initialisation de registres avec des constantes via des opérations du type \verb!r = add 5, 0! ou \verb!r = or true, false! pour l'initialisation de booléens.
\end{itemize}
