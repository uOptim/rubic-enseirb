...
Le problème de la détermination du type des variables se manifeste particulièrement dans les fonctions. En effet, lorsque la définition d'une fonction est rencontrée, le type de ses paramètres n'est pas connus et par conséquent le type des variables locales à la fonction peut également être indéterminé.
